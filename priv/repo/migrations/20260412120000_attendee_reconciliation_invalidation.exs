defmodule FastCheck.Repo.Migrations.AttendeeReconciliationInvalidation do
  ...
  def up do
    ...
    create constraint(:attendees, :scan_eligibility_valid,
             check: "scan_eligibility IN ('active', 'not_scannable')"
           )

    create index(:attendees, [:event_id, :scan_eligibility],
    ...
    create index(:attendee_invalidation_events, [:event_id, :id],
             name: :attendee_invalidation_events_event_id_id_idx
           )

    create index(:attendee_invalidation_events, [:event_id, :inserted_at],
             name: :attendee_invalidation_events_event_id_inserted_at_idx
           )
  end

  def down do
    drop index(:attendee_invalidation_events,
           name: :attendee_invalidation_events_event_id_inserted_at_idx
         )

    drop index(:attendee_invalidation_events, name: :attendee_invalidation_events_event_id_id_idx)
