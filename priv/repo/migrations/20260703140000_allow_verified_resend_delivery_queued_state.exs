defmodule FastCheck.Repo.Migrations.AllowVerifiedResendDeliveryQueuedState do
  use Ecto.Migration
  ...
  @down_states @up_states -- ["verified_resend_delivery_queued"]
  ...
  def down do
    ...
    SET state = 'main_menu',
        ...
        updated_at = NOW()
    WHERE state = 'verified_resend_delivery_queued'
    """)
