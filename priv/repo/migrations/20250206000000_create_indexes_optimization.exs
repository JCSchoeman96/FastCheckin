defmodule PetalBlueprint.Repo.Migrations.CreateIndexesOptimization do
  ...
  def change do
    ...
    create_if_not_exists index(:attendees, [:event_id, :checked_in_at],
                           name: :idx_attendees_event_checked)
    ...
    create_if_not_exists index(:attendees, [:event_id, :ticket_code],
                           name: :idx_attendees_event_code)
    ...
    create_if_not_exists index(:check_ins, [:entrance_name], name: :idx_check_ins_entrance)
  end
end
