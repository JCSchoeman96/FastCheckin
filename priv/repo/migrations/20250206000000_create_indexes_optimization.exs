defmodule FastCheck.Repo.Migrations.CreateIndexesOptimization do
  ...
  def change do
    ...
    # DUPLICATE: This index already exists as idx_attendees_checked_in in 20250115000000_create_event_tables.exs
    ...
    # DUPLICATE: This index already exists in 20250115000000_create_event_tables.exs (line 45)
    ...
    # DUPLICATE: This index already exists in 20250115000000_create_event_tables.exs (line 66)
