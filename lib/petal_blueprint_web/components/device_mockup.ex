defmodule PetalBlueprintWeb.Components.DeviceMockup do
  @moduledoc """
  The `PetalBlueprintWeb.Components.DeviceMockup` module provides a customizable component for displaying
