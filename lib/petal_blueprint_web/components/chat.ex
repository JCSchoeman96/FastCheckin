defmodule PetalBlueprintWeb.Components.Chat do
  @moduledoc """
  `PetalBlueprintWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
