defmodule PetalBlueprintWeb.Components.Popover do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
