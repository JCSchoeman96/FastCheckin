defmodule PetalBlueprintWeb.Components.MegaMenu do
  @moduledoc """
  The `PetalBlueprintWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
