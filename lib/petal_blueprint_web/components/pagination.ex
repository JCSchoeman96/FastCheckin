defmodule PetalBlueprintWeb.Components.Pagination do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Pagination` module provides a comprehensive and highly customizable
