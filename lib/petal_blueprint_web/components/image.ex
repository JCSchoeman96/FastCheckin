defmodule PetalBlueprintWeb.Components.Image do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
