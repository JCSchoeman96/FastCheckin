defmodule PetalBlueprintWeb.Components.CheckboxCard do
  @moduledoc """
  The `PetalBlueprintWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
