defmodule PetalBlueprintWeb.Components.UrlField do
  @moduledoc """
  PetalBlueprintWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
