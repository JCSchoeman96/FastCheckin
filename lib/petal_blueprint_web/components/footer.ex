defmodule PetalBlueprintWeb.Components.Footer do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
