defmodule PetalBlueprintWeb.Components.Rating do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
