defmodule PetalBlueprintWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `PetalBlueprintWeb.Components.Carousel`
  project.
