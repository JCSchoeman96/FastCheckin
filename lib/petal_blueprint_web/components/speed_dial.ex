defmodule PetalBlueprintWeb.Components.SpeedDial do
  @moduledoc """
  The `PetalBlueprintWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
