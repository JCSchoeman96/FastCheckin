defmodule PetalBlueprintWeb.Components.Skeleton do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
