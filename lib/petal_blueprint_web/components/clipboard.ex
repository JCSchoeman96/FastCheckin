defmodule PetalBlueprintWeb.Components.Clipboard do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
