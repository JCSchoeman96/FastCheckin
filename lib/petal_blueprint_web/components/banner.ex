defmodule PetalBlueprintWeb.Components.Banner do
  @moduledoc """
  PetalBlueprintWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
