defmodule PetalBlueprintWeb.Components.Stepper do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `PetalBlueprintWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
