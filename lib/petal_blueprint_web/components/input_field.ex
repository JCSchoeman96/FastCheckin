defmodule PetalBlueprintWeb.Components.InputField do
  @moduledoc """
  The `PetalBlueprintWeb.Components.InputField` module provides a customizable input field component that
