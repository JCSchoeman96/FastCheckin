defmodule PetalBlueprintWeb.Components.FileField do
  @moduledoc """
  The `PetalBlueprintWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PetalBlueprintWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PetalBlueprintWeb.Gettext, "errors", msg, opts)
    end
  end
end
