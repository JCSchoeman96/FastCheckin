defmodule PetalBlueprintWeb.Components.ToggleField do
  @moduledoc """
  PetalBlueprintWeb.Components.ToggleField component renders a toggle field with customizable options.
