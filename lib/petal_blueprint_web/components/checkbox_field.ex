defmodule PetalBlueprintWeb.Components.CheckboxField do
  @moduledoc """
  PetalBlueprintWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
