defmodule PetalBlueprintWeb.Components.Gallery do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Gallery` module provides a customizable gallery component for displaying
