defmodule PetalBlueprintWeb.Components.Tabs do
  @moduledoc """
  `PetalBlueprintWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import PetalBlueprintWeb.Components.Badge, only: [badge: 1]
