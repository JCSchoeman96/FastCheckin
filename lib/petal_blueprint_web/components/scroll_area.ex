defmodule PetalBlueprintWeb.Components.ScrollArea do
  @moduledoc """
  The `PetalBlueprintWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
