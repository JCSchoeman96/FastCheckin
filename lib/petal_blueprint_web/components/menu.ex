defmodule PetalBlueprintWeb.Components.Menu do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `PetalBlueprintWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import PetalBlueprintWeb.Components.Button, only: [button_link: 1]
