defmodule PetalBlueprintWeb.Components.NativeSelect do
  @moduledoc """
  The `PetalBlueprintWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `PetalBlueprintWeb.Components.NativeSelect`
