defmodule PetalBlueprintWeb.Components.Spinner do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `PetalBlueprintWeb.Components.Spinner` module enables developers to provide
