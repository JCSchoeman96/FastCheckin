defmodule PetalBlueprintWeb.Components.Indicator do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Indicator` module provides a versatile component for visually highlighting
