defmodule PetalBlueprintWeb.Components.Overlay do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `PetalBlueprintWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
