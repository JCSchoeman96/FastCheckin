defmodule PetalBlueprintWeb.Components.Jumbotron do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Jumbotron` module provides a versatile component for creating large,
