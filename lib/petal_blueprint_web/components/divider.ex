defmodule PetalBlueprintWeb.Components.Divider do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  @doc """
  `PetalBlueprintWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
