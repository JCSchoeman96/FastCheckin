defmodule PetalBlueprintWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `PetalBlueprintWeb.Components.Breadcrumb` component for displaying
