defmodule PetalBlueprintWeb.Components.Modal do
  @moduledoc """
  The `PetalBlueprintWeb.Components.Modal` module provides a versatile and customizable modal component for
