defmodule PetalBlueprintWeb.Components.TableContent do
  @moduledoc """
  `PetalBlueprintWeb.Components.TableContent` is a component module designed to create flexible and dynamic
