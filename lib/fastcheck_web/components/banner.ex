defmodule FastCheckWeb.Components.Banner do
  @moduledoc """
  FastCheckWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
