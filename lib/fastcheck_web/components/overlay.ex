defmodule FastCheckWeb.Components.Overlay do
  @moduledoc """
  The `FastCheckWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `FastCheckWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
