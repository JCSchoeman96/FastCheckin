defmodule FastCheckWeb.Components.CheckboxCard do
  @moduledoc """
  The `FastCheckWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
