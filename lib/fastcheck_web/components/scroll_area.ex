defmodule FastCheckWeb.Components.ScrollArea do
  @moduledoc """
  The `FastCheckWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
