defmodule FastCheckWeb.Components.CheckboxField do
  @moduledoc """
  FastCheckWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
