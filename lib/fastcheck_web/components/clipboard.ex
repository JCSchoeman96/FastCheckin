defmodule FastCheckWeb.Components.Clipboard do
  @moduledoc """
  The `FastCheckWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
