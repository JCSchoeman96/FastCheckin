defmodule FastCheckWeb.Components.Menu do
  @moduledoc """
  The `FastCheckWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `FastCheckWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import FastCheckWeb.Components.Button, only: [button_link: 1]
