defmodule FastCheckWeb.Components.Alert do
  @moduledoc """
  FastCheckWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
