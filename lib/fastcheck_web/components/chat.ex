defmodule FastCheckWeb.Components.Chat do
  @moduledoc """
  `FastCheckWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
