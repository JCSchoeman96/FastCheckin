defmodule FastCheckWeb.Components.Rating do
  @moduledoc """
  The `FastCheckWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
          ...
          >
            ...
            >
              ...
              <% else %>
                ...
                />
              <% end %>
            </svg> <span class="sr-only">{gettext("Rate %{count} star", count: item)}</span>
          </button>
        <% else %>
          <svg
            xmlns="http://www.w3.org/2000/svg"
