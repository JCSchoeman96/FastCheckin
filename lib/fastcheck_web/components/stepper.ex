defmodule FastCheckWeb.Components.Stepper do
  @moduledoc """
  The `FastCheckWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `FastCheckWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
