defmodule FastCheckWeb.Components.Divider do
  @moduledoc """
  The `FastCheckWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  @doc """
  `FastCheckWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
