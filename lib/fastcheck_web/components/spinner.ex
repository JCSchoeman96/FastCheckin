defmodule FastCheckWeb.Components.Spinner do
  @moduledoc """
  The `FastCheckWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `FastCheckWeb.Components.Spinner` module enables developers to provide
