defmodule FastCheckWeb.Components.Footer do
  @moduledoc """
  The `FastCheckWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
