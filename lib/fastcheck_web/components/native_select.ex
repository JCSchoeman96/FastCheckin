defmodule FastCheckWeb.Components.NativeSelect do
  @moduledoc """
  The `FastCheckWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `FastCheckWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FastCheckWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FastCheckWeb.Gettext, "errors", msg, opts)
    end
  end
end
