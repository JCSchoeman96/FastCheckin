defmodule FastCheckWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("fastcheck.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("fastcheck.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("fastcheck.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("fastcheck.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("fastcheck.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
